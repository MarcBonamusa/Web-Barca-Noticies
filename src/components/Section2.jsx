...
const matchesData = [
  { rival: "Real Madrid", date: "20/11/2025", score: "2-1", image: "https://static.vecteezy.com/system/resources/previews/044/626/810/non_2x/real-madrid-logo-on-transparent-background-free-vector.jpg" },
  { rival: "Sevilla FC", date: "27/11/2025", score: "3-0", image: "https://www.viniloscasa.com/28226-thickbox/vinilos-escudo-sevilla-futbol-club.jpg" },
  { rival: "Atlético de Madrid", date: "04/12/2025", score: "1-1", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiZ-i-e3PtkzsmVWv3PQJNN9CcKzOV8LAeAg&s" },
  { rival: "Valencia CF", date: "10/12/2025", score: "4-2", image: "https://assets.goal.com/images/v3/blte1406ea8a29c6bc6/1c834fa5be327b369511710ca95d66407bbb6b54.jpg?auto=webp&format=pjpg&width=3840&quality=60" }
];
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-20">
            {matchesData.map((_, index) => (
              <button
                ...
                aria-label={`Ir al partit ${index + 1}`}
              />
            ))}
          </div>
        </div>
